 ...
 */
var GATWebView = React.createClass({
  ...
  render: function() {
   ...
   if (this.state.viewState === WebViewState.LOADING) {
      ...
      console.error('GWebView invalid state encountered: ' + this.state.loading);
    }
  ...
  onCallBackMessage : function(event){
