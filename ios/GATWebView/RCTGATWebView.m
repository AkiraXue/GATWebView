...
NSString *const RCTWebViewScheme = @"react-js-navigation";

@interface RCTGATWebView () <UIWebViewDelegate, RCTAutoInsetsProtocol>

@property (nonatomic, copy) RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) RCTDirectEventBlock onCallBackMessage;
@property (nonatomic, copy) RCTDirectEventBlock onShouldStartLoadWithRequest;

@end

@implementation RCTGATWebView
{
  UIWebView *_webView;
...
-(void)callJavaScript:(NSString *)message{
